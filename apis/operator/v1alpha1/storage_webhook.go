...
func (r *Storage) Default() {
	...
	if r.Spec.ConnectType == "" {
		r.Spec.ConnectType = "internal"
	}
...
func (r *Storage) valid() error {
	...
	if !apiequal.Semantic.DeepDerivative(r.Spec.Type, "elasticsearch") && !apiequal.Semantic.DeepDerivative(r.Spec.Type, "elasticsearch7") {
